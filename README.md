...
Repositorio con el código fuente en LaTeX del reporte de investigación correspondiente al curso impartido en el \*\*Centro de Investigación en Matemáticas (CIMAT)\*\*.
...
\* \*\*\[Tu Nombre]\*\* - \*Facultad de Ciencias, UNAM\*
